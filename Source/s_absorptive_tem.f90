...
#else
    forward_plan = fft_plan(nopiy,nopix,psi,-1)
    inverse_plan = fft_plan(nopiy,nopix,psi,+1)
#endif
...
!            endif
        ...
        if(n_tilts_total>1) write(6,901,advance='no') achar(13),i_cell, ntilt,n_tilts_total, intensity
900     format(1a,1x, 'Cell: ', i5, ' Intensity: ', f12.6)
901     format(1a,1x, 'Cell: ', i5, ' tilt:',i5,'/',i5,' Intensity: ', f12.6)
#endif
